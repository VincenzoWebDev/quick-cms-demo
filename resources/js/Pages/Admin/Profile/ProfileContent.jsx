                        ...
                        <div className="card mt-3">
                            <ul className="list-group list-group-flush">
                                ...
                                <li className="list-group-item d-flex justify-content-between align-items-center flex-wrap">
                                    ...
                                    <span className="text-secondary">https://github.com/VincenzoWebDev/quick-cms</span>
                                </li>
                                <li className="list-group-item d-flex justify-content-between align-items-center flex-wrap">
                                    <h6 className="mb-0"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="feather feather-twitter mr-2 icon-inline text-info"><path d="M23 3a10.9 10.9 0 0 1-3.14 1.53 4.48 4.48 0 0 0-7.86 3v1A10.66 10.66 0 0 1 3 4s-4 9 5 13a11.64 11.64 0 0 1-7 2c9 5 20 0 20-11.5a4.5 4.5 0 0 0-.08-.83A7.72 7.72 0 0 0 23 3z"></path></svg>Twitter</h6>
                                    <span className="text-secondary small">no-data</span>
                                </li>
                                <li className="list-group-item d-flex justify-content-between align-items-center flex-wrap">
                        ...
                        <div className="card mb-3">
                            <div className="card-body">
                                ...
                                <div className="row">
                                    ...
                                    {editable ? (
                                        <input type="text" name="name" value={data.name} onChange={handleInputChange} className="form-control w-50" readOnly />
                                    ) : (
                                        <div className="col-sm-9 text-secondary">
                                            {user_auth.name}
                                        </div>
                                ...
                                <div className="row">
                                    ...
                                    {editable ? (
                                        <input type="text" name="lastname" value={data.lastname} onChange={handleInputChange} className="form-control w-50" readOnly />
                                    ) : (
                                        <div className="col-sm-9 text-secondary">
                                            {user_auth.lastname}
                                        </div>
                                ...
                                <div className="row">
                                    ...
                                    {editable ? (
                                        <input type="text" name="email" value={data.email} onChange={handleInputChange} className="form-control w-50" readOnly />
                                    ) : (
                                        <div className="col-sm-9 text-secondary">
                                            {user_auth.email}
                                        </div>
                                ...
                                <div className="row">
                                    ...
                                    {user_auth.role === 'admin' &&
                                        editable ? (
                                        <input type="text" name="role" value={data.role} onChange={handleInputChange} className="form-control w-50" readOnly />
                                    ) : (
                                        <div className="col-sm-9 text-secondary">
                                            {user_auth.role
                                            }
