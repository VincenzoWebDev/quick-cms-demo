                    ...
                    <div className="row">
                            ...
                            <div className="card shadow-0 border">
                                <div className="p-4">
                                    ...
                                    <div className="float-end">
                                        ...
                                        <button className="btn btn-success shadow-0 border" onClick={handleSubmit} disabled>Continua</button>
                                    </div>
                                </div>
                            </div>
                            {/* Checkout */}
                        ...
                        <div className="col-xl-4 col-lg-4 d-flex justify-content-center justify-content-lg-end">
                            <div className="ms-lg-4 mt-4 mt-lg-0" style={{ maxWidth: '320px', color: '#212529' }}>
                                ...
                                <button className="btn btn-dark w-100 mt-3" disabled>Paga ora</button>
